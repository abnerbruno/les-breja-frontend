...
class EditarCerveja extends Component {
  ...
  async handleSubmit(event) {
    ...
    console.log(
      `será feito um requet : /api/cerveja ${cerveja.id} ? /  ${cerveja.id} `
    );
  ...
  render() {
    const { cerveja } = this.state;
    const title = <h2 className="text-center">{cerveja.id ? "Editar Cerveja" : "Nova Cerveja"}</h2>;
        ...
        <Container className="bg-light">
          ...
          <form onSubmit={this.handleSubmit}>
                ...
                <div className="row">
                  ...
                  <div className="mb-3 col">
                    <input
                      ...
                      aria-label="dataCadastro"
                      name="dataCadastro"
                      value={cerveja.dataCadastro || ""}
                      onChange={this.handleChange}
                    />
                  </div>
            ...
            <FormGroup>
              ...
              <Button color="secondary" tag={Link} to="/listaCerveja">
                Cancelar
              </Button>{" "}
            </FormGroup>
          </form>
